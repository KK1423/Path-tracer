...
ray getCameraRay (int x, int y, int height, int width, float recipjitter, float flength, float fdistance)
{
...
int main()
{
    ...
    while (sce.passnumber<samples)
    {
        ...
        t = clock();
        p = sce.passnumber;
        thread section2(computeSection,501,999,0,500,regimage,sce);
        thread section3(computeSection,501,999,501,999,regimage,sce2);
        thread section4(computeSection,0,500,501,999,regimage,sce3);
        computeSection(0,500,0,500,regimage,sce4);
        section2.join();
        section3.join();
        section4.join();
        sce.passnumber++;
